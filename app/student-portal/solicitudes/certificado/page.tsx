...
export default function CertificadoRequestPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-12 border border-white/10 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-black mb-4">Solicitud de Certificado</h1>
            <p className="text-white/60 text-lg max-w-xl mx-auto mb-8 leading-relaxed">
              Este módulo está siendo actualizado para integrarse con el nuevo ecosistema APEX. 
              Pronto podrás solicitar y descargar tus certificados oficiales directamente desde este panel.
            </p>

            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/5 rounded-full border border-white/10">
              <Clock className="w-5 h-5 text-brand-orange" />
              <span className="text-sm font-bold uppercase tracking-widest text-brand-orange">Módulo en construcción</span>
            </div>
          </div>
        </div>
      </div>
