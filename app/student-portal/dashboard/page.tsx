        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/student-portal" className="p-2 hover:bg-white/10 rounded-lg transition-colors">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href="/student-portal/documents" className="text-lime-400 hover:text-lime-300 text-sm font-medium transition-colors">
                    Ver todos →
                  </Link>
                </div>
              </div>
