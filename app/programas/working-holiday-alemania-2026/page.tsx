...
export const metadata: Metadata = {
  ...
  facebook: {
    appId: process.env.NEXT_PUBLIC_FB_APP_ID || '1956792428547252', 
  },
};
    ...
    <IceLayoutWrapper>
      <div className="relative w-full bg-white">
        ...
        <section className="relative pt-32 pb-24 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
          ...
          <div className="w-full px-4 sm:px-8 lg:px-16 xl:px-24 relative z-10 flex justify-end">
            <div className="text-right max-w-2xl lg:max-w-3xl">
