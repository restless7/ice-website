    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-black">
      ...
      <div className="relative z-10">
          ...
          >
            <div className="relative w-full max-w-2xl mx-auto">
              <div className="bg-gradient-to-br from-slate-800/30 to-slate-900/30 rounded-3xl p-8 border border-cyan-400/20 backdrop-blur-sm">
                <div className="aspect-video bg-slate-700/30 rounded-2xl border-2 border-dashed border-cyan-400/30 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-cyan-400/10 rounded-xl flex items-center justify-center">
                      <ShieldCheckIcon className="w-8 h-8 text-cyan-400" />
                    </div>
                    <p className="text-cyan-400 font-semibold text-lg mb-2">Data Protection Triad</p>
                    <p className="text-gray-400 text-sm">Placeholder para: data-protection-triad.jpg</p>
                  </div>
                </div>
                {/* Image component ready for when you add the actual image */}
                {/* <Image
        ...
        >
          ...
          >
            <div className="relative w-full max-w-2xl mx-auto">
              <div className="bg-gradient-to-br from-slate-800/30 to-slate-900/30 rounded-3xl p-8 border border-purple-400/20 backdrop-blur-sm">
                <div className="aspect-video bg-slate-700/30 rounded-2xl border-2 border-dashed border-purple-400/30 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-purple-400/10 rounded-xl flex items-center justify-center">
                      <CogIcon className="w-8 h-8 text-purple-400" />
                    </div>
                    <p className="text-purple-400 font-semibold text-lg mb-2">CSF Framework</p>
                    <p className="text-gray-400 text-sm">Placeholder para: CSF-framework.jpg</p>
                  </div>
                </div>
                {/* Image component ready for when you add the actual image */}
                {/* <Image
                  src="/images/CSF-framework.jpg"
                  alt="NIST Cybersecurity Framework - Identify, Protect, Detect, Respond, Recover"
                  width={800}
                  height={450}
                  className="w-full h-auto rounded-2xl"
                  priority
